 ...
 */
public class Story {
    /*  This is the Java class where we populate each pages */

    private Page[] mPages;

    public Story () {
        mPages = new Page[7];   //  We have a total of 7 pages

        mPages[0] = new Page(R.mipmap.page0,
                "On your return trip from studying Saturn's rings, you hear a distress signal that seems to be coming from the surface of Mars. " +
                "It's strange because there hasn't been a colony there in years. Even stranger, it's calling you by name: \"Help me, %1$s, you're my only hope.\""
